...
% Refs format
\newcommand{\figref}[1]{
	\color{figtextcolor}\textbf{Figure}~\ref{fig:#1} \color{normaltextcolor}
}
...
As you probably learned in school, a \emph{triangle} is a shape with three sides. An example of a triangle can be seen in \figref{triangle}.
