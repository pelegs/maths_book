...
We can verify that $z_{2}$ indeed solves the equation using its Cartesian form\footnote{Using $(a+b)^{3}=a^{3}+3a^{2}b+3ab^{2}+b^{3}$.}:
\begin{align}
	\left( -\frac{1}{2}+\frac{\sqrt{3}}{2} \right)^{3} &= -\frac{1}{8} + 3\frac{\sqrt{3}}{8}i - 3\frac{3}{8}i^{2} + \frac{3\sqrt{3}}{8}i^{3}\nonumber\\
	&= -\frac{1}{8} + \cancel{3\frac{\sqrt{3}}{8}i} + 3\frac{3}{8} - \cancel{3\frac{\sqrt{3}}{8}i}\nonumber\\
	&= -\frac{1}{8} + \frac{9}{8}\nonumber\\
	&= 1.
	\label{eq:bla}
\end{align}
...
The general formula for the solutions to \eqref{power_equation_complex} all have magnitude $r=1$ and angle
\begin{equation}
	\theta_{k} = \frac{2\pi}{n}k,
	\label{eq:soltions to z^n=1}
\end{equation}
where $k=1,2,\dots,n$. See figure xxx for the solutions to several more values of $n$.
...
\begin{figure}
	...
	\end{subfigure}
	\caption{Complex solutions for $z^{n}=1$ for $n=4,5,6,7$. Note that for all circles $r=1$.}
\end{figure}
