...
\begin{itemize}
  ...
  \item Lagrange's trigonometric identities: for any $\theta\neq2\pi k$ where $k\in\mathbb{Z}$,
    \begin{align}
      \sum\limits_{k=0}^{n}\sin\left(k\theta\right) = \frac{\cos\left(\frac{1}{2}\theta\right)-\cos\left(\left[n+\frac{1}{2}\right]\theta\right)}{2\sin\left(\frac{1}{2}\theta\right)}.\\
      \sum\limits_{k=0}^{n}\cos\left(k\theta\right) = \frac{\sin\left(\frac{1}{2}\theta\right)+\sin\left(\left[n+\frac{1}{2}\right]\theta\right)}{2\sin\left(\frac{1}{2}\theta\right)}.\\
    \end{align}
\end{itemize}
...
\label{sub:Hyperbolic_functions}
