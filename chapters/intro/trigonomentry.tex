...
\begin{table}
	\caption{Common angles in radians, and their respective images for the three main trigonometic functions.}
	\label{tab:rad_degs}
	\centering
	\begin{tabular}{lcccc}
		\toprule
...
\end{equation}
Subtituting this back to \autoref{eq:area of a triangle} yields that the area of the triangle is
\begin{equation}
