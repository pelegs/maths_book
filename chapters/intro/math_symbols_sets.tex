...
\begin{note}{(not so) Surprising properties of subsets}{subset_properties}
	The definion of a subset (\autoref{eq:subset_def}) gives rise to two interesting properties:
	\begin{itemize}
