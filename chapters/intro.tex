...
The \textbf{AND} operator returns a \true\ statement only if \textbf{both} the statements it groups are themselves \true, otherwise it returns \false.
...
The behaviour of both operators can be summarized using a \emph{truth table}:
\begin{table}[H]
	\centering
