...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		% A
		\fill[xred] (-1.15,-0.12) circle (0.05);
		\fill[xred] (-1.82,-1.01) circle (0.05);
		\fill[xred] (-1.28,-1.03) circle (0.05);
		\fill[xred] (-1.68,+0.05) circle (0.05);
		\fill[xred] (-0.51,-1.25) circle (0.05);
		\fill[xred] (-1.41,+0.25) circle (0.05);
		\fill[xred] (-1.60,+1.25) circle (0.05);
		%	B
		\fill[xblue] (1.70,0.54) circle (0.05);
		\fill[xblue] (1.48,0.06) circle (0.05);
		\fill[xblue] (1.51,-0.94) circle (0.05);
		%fill[
		\fill[xgreen!75] (-0.16,0.24) circle (0.05);
		\fill[xgreen!75] (0.13,0.53) circle (0.05);
		\fill[xgreen!75] (0.06,-0.78) circle (0.05);
	\end{tikzpicture}
