...
% Injective function
				\fill[xred!20, draw=xred, thick] (0,0) circle (0.75cm and 2cm) node [above, yshift=2cm, text=xred] {$A$};
				\node (A1) at (0,1.5) {$1$};
				\node (A2) at (0,0.5) {$2$};
				\node (A3) at (0,-0.5) {$3$};
				\node (A4) at (0,-1.5) {$4$};

				\fill[xgreen!20, draw=xgreen, thick] (2,0) circle (0.75cm and 1.75cm) node [above, yshift=2cm, text=xgreen] {$B$};
...
% Non injective function
				\fill[xred!20, draw=xred, thick] (6,0) circle (0.75cm and 2cm) node [above, yshift=2cm, text=xred] {$A$};
				\node (A1b) at (6,1.5) {$1$};
				\node (A2b) at (6,0.75) {$2$};
				\node (A3b) at (6,0) {$3$};
				\node (A4b) at (6,-0.75) {$4$};
				...
				\fill[xgreen!20, draw=xgreen, thick] (8,0) circle (0.75cm and 1.75cm) node [above, yshift=2cm, text=xgreen] {$B$};
