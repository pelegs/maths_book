...
\begin{figure}
	...
	\begin{subfigure}[c]{0.37\textwidth}
		...
		\caption{Scaling in $x$}
		\label{fig:}
	\end{subfigure}
	\begin{subfigure}[c]{0.29\textwidth}
		\centering
		\tapirTrans{1}{0}{0}{1.3}{5cm}
		\caption{Scaling in $y$}
		\label{fig:}
	\end{subfigure}
	\hfill
	\begin{subfigure}[c]{0.3\textwidth}
		...
		\caption{Skewing in $x$}
		\label{fig:}
	\end{subfigure}
	\begin{subfigure}[c]{0.3\textwidth}
		\centering
		\tapirTrans{1}{0.5}{0}{1}{5cm}
		\caption{Skewing in $y$}
		\label{fig:}
	\end{subfigure}
	...
	\begin{subfigure}[c]{0.3\textwidth}
		...
		\label{fig:}
	\end{subfigure}
	\caption{The ``fundamental'' linear transformations, exemplified using a very happy and colorful tapir.}
