	...
	\begin{subfigure}[c]{0.47\textwidth}
		\begin{center}
			...
			\begin{tikzpicture}[tdplot_main_coords]
				...
				\draw[ultra thick, xgreen] (0,0,0) -- (0.267,0.534,0.802);
				\begin{scope}[canvas is plane={O(0.267,0.535,0.802)x(1.231,0.386,0.549)y(0.267,-0.298,1.356)}]
					\fill[xgreen, opacity=0.2] (-1,-1) rectangle (1,1);
					\draw[step=0.5, xdarkgreen] (-1,-1) grid (1,1);
					\draw[vector, xdarkgreen!80!black, dotted] (0.5,0) arc (0:177:0.5);
					\draw[vector, xdarkgreen!80!black, dotted] (-0.5,0) arc (180:362:0.5);
				\end{scope}
				\draw[vector, xgreen] (0.267,0.534,0.802) -- (0.534,1.069,1.604) node[pos=1.15] {$\hat{r}$};
			\end{tikzpicture}
		\end{center}
	\end{subfigure}%
	\begin{subfigure}[c]{0.47\textwidth}
		\begin{center}
			...
			\begin{tikzpicture}[tdplot_main_coords]
				...
				\begin{scope}[canvas is plane={O(0.267,0.535,0.802)x(1.231,0.386,0.549)y(0.267,-0.298,1.356)}]
					...
					\draw[vector, xdarkgreen!80!black, dotted] (-0.5,0) arc (180:362:0.5);
				\end{scope}
				\draw[vector, xgreen] (0.267,0.534,0.802) -- (0.534,1.069,1.604) node[pos=1.1] {$\hat{r}$};
			\end{tikzpicture}
		\end{center}
	\end{subfigure}
	\caption{Rotation around a direction $\hat{r}$ from two different viewpoints.}
