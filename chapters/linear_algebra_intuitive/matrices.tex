...
The following table summarizes all the matrices of the basic transformations:
...
\begin{longtable}{lcccc}
	...
	Scale in $y$ & \tikz[baseline=-0.5ex]{\tapirTransComp{1}{0}{0}{1.2}{0}{0}{}} & $\colvec{1;0}$ & $\colvec{0;s}$ & $\begin{bmatrix} 1&0 \\ 0&s \end{bmatrix}$\\
	...
	Reflection by line & \tikz[baseline=-0.5ex]{\tapirTransComp{0.882}{0.471}{0.471}{-0.882}{0}{0}{}} & $\colvec{-1;0}$ & $\colvec{0;1}$ & $\begin{bmatrix} \text{TBD}&\text{TBD} \\ \text{TBD}&\text{TBD} \end{bmatrix} $\\
