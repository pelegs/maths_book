...
\begin{challange}{Upper/lower triangular matrices}{}
...
\begin{example}{The determinant as a scaling factor}{}
	...
	\begin{tikzpicture}
		\begin{axis}[
			...
			\draw[thick, xred, fill=xred!20] (-4,-4) rectangle (-3,-3);
			\draw[thick, xgreen, fill=xgreen!20] (-2,-4) rectangle (0,-1);
			\draw[thick, xpurple, fill=xpurple!20] (4,2) arc (0:360:1.5);
		\end{axis}
		...
		\begin{axis}[
			...
			\draw[thick, xpurple, fill=xpurple!20] (4,2) arc (0:360:1.5);
		\end{axis}
		\draw[vector] (-1.3cm,3.5cm) -- ++(1cm,0) node[midway, above] {$A$};
	\end{tikzpicture}
\end{example}
