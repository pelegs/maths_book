...
Later we will examine some common properties of the scalar product, and see how we can calculate it directly from the vectors in their column form. Beofre we do that, we use what we learned about the product so far to solve some easy problems in the examples below.
