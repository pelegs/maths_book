...
Let's prove this idea using what we already know by directly calculating the norm of a scaled vector:
\begin{proof}{Scaling a column vector}{}
	The vector $\vec{w}=\colvec{\alpha v_{1};\alpha v_{2};\vdots;\alpha v_{n}}$ has the following norm:
	\begin{align*}
