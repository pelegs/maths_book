...
\begin{note}{Coordinates of the basis vectors}{}
  Since the column representation of vectors depends on the coordinate syste, one must always be sure with which basis vectors they are working - otherwise mistakes are bound to happen and calculations might make no sense.
\end{note}
