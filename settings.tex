...
\pgfkeyssetvalue{/xref dict/4}{tapir_fourier}
\pgfkeyssetvalue{/xref dict/5}{tapir_butterfly}
\pgfkeyssetvalue{/xref dict/6}{tapir_warhol}
\pgfkeyssetvalue{/xref dict/7}{tapir_strawberry_two}
...
\usetikzlibrary{positioning, calc, decorations.pathreplacing, decorations.text, angles, quotes}

\tikzset{
	arrow/.style={thick, ->, >=stealth},
	vector/.style={very thick, ->, >=stealth, cap=round},
...
\newtcbtheorem[auto counter, number within=chapter]{challange}{Challange}{challangestyle}{challange}
...
% Colored (common) vectors I use
\newcommand{\vu}{\textcolor{xred}{\bm{\vec{u}}}}
\newcommand{\vv}{\textcolor{xblue}{\bm{\vec{v}}}}
\newcommand{\vw}{\textcolor{xpurple}{\bm{\vec{w}}}}
