...
\definecolor{xsoftred}{HTML}{F0A8A8}
\definecolor{xsoftblue}{HTML}{9BAADD}
\definecolor{xsoftgreen}{HTML}{9AE3B7}
...
\tcbset{
	...
	Motivationstyle/.style={
		common={xred}{\textbf{\faPuzzlePiece}},
	},
}
...
\newtcbtheorem[auto counter, number within=chapter]{motivation}{Motivation}{Motivationstyle}{motivation}
...
\newcommand{\sumterm}[3]{
  \tikz[baseline=-0.5ex, node distance=17pt]{\node[fill=#2, opacity=1, fill opacity=0.25, text opacity=1](ki){#1};\node[below of=ki, #2]{#3};}
}
