...
\usetikzlibrary{backgrounds, positioning, calc, decorations.pathreplacing, decorations.text, angles, quotes, perspective, tikzmark, fpu, matrix, fit, shapes}
...
\newcommand{\IdentityHl}[3]{
	...
	\begin{tikzpicture}[overlay, remember picture, blend mode=multiply]
		\foreach \k in {1,...,#1}{
			\node[fill=#3, rectangle, minimum width=10pt, minimum height=10pt] at (#2-\k-\k) {}; 
		}
	\end{tikzpicture}
}
